...
function normalizeCityName(cityName) {
  ...
  // Eliminar espacios extra y capitalizar correctamente
  const words = cityName.trim().split(' ');
  return words
    .map((word, index) => {
      const lower = word.toLowerCase();
      // Primera palabra siempre con mayúscula, las preposiciones en minúscula
